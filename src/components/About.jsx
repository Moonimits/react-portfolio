        ...
        <div className="col-12 col-lg-6 pt-4 pt-lg-0">
          <div className="border-main-color bg-dark p-4">
            ...
            <p className="text-justify">
              ...
              Bootstrap since it was the tool for creating a responsive website.
              For the Backend Development, I studied and used PHP and used
              Phpmyadmin for the database. Over the course of my Academic Year I
              also learned other programming languages.
            </p>
